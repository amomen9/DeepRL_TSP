"""
Experiment_CriticNN.py - PPO critic network-architecture ablation, reproduced in
one command. TSP analogue of the CartPole fork's dedicated Experiment_*.py sweeps.

Run from the project root with:  python "Ablation Scripts/Experiment_CriticNN.py"
"""
...
if __name__ == "__main__":
    Test_TSP(overrides={
        ...
        "ppo_config": {"critic_hidden_nn": [[128, 128], [256, 256], [512, 512]]},
    })
